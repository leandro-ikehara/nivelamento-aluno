...
def remove_ultimo(array)
    ...
    # array = novo_array # isso apenas vai "setar" o endereço de novo_array em array 
    # (mas ao final da função, array perde o escopo e a variavel de fora continua apontando 
